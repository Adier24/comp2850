                                ...
                                return Container(
                                  ...
                                  child: Center(
                                    child: CircularProgressIndicator(
                                      color: Color.fromARGB(255, 35, 102, 245),
                      ...
                      ? Material(
                          child: Image.network(
                            ...
                            loadingBuilder: (BuildContext context, Widget child, ImageChunkEvent? loadingProgress) {
                              ...
                              return Center(
                                child: CircularProgressIndicator(
                                  color: const Color.fromARGB(255, 35, 119, 245),
                                  value: loadingProgress.expectedTotalBytes != null
                                      ? loadingProgress.cumulativeBytesLoaded / loadingProgress.expectedTotalBytes!
                                      : null,
                                ),
                                  ...
                                  child: Image.network(
                                    ...
                                    loadingBuilder:
                                      ...
                                      return Container(
                                        ...
                                        child: Center(
                                          child: CircularProgressIndicator(
                                            color: const Color.fromARGB(255, 35, 133, 245),
                                            value: loadingProgress.expectedTotalBytes != null
          ...
          ? StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (snapshot.hasData) {
                  ...
                  return Center(
                    child: CircularProgressIndicator(
                      color: const Color.fromARGB(255, 35, 109, 245),
                    ),
                  );
                }
              },
